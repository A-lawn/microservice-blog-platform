...
import com.blog.platform.comment.infrastructure.config.ConfigChangeListener;
import com.blog.platform.comment.infrastructure.config.DynamicConfigProperties;
...
public class ConfigController {
    ...
    public Map<String, Object> getCurrentConfig() {
        ...
        config.put("maxCommentLength", dynamicConfigProperties.getMaxCommentLength());
        config.put("maxReplyDepth", dynamicConfigProperties.getMaxReplyDepth());
        config.put("enableModeration", dynamicConfigProperties.isEnableModeration());
        config.put("enableNotification", dynamicConfigProperties.isEnableNotification());
